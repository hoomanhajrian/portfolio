        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 md:h-16">
            ...
            <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all no-underline ${
                    isActive(link.path)
                      ...
                      : 'text-gray-700 dark:text-gray-300 hover:text-sky-500 dark:hover:text-sky-400 hover:bg-gray-100 dark:hover:bg-gray-700'
                  }`}
                >
                  {link.label}
                </Link>
              ...
              {/* Social Links */}
              <a
                href="https://www.linkedin.com/in/hooman-hajarian/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-sky-500 dark:hover:text-sky-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <div className="px-4 py-3 space-y-1">
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`block px-4 py-3 rounded-lg font-medium transition-all no-underline ${
                      isActive(link.path)
                        ? 'text-sky-500 dark:text-sky-400 bg-sky-50 dark:bg-sky-900/20'
                        : 'text-gray-700 dark:text-gray-300 hover:text-sky-500 dark:hover:text-sky-400 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
